<template>
  ...
  <div class="hidden md:block">
    <div class="gallery-view noselect" v-for="file in files" :key="file.id">
      <nuxt-link v-if="file.nsfw" :href="'/v/' + file.id + '.' + file.ext"
        ><Image
          ...
          alt=""
      /></nuxt-link>
      <nuxt-link v-else :href="'/v/' + file.id + '.' + file.ext"
        ><Image
          style="cursor: pointer"
          :src="file.url"
          draggable="false"
  ...
  <div class="md:hidden">
    <div
      class="gallery-view-mb noselect md:hidden"
      v-for="file in files"
      :key="file.id"
    >
      <nuxt-link v-if="file.nsfw" :href="'/v/' + file.id + '.' + file.ext"
